...
It also includes:
 ...
 - A control panel (based on [vimbadmin](http://vimbadmin.net/)) for adding/removing mail users, aliases, etc.
 - A multi admin system.
 - Autoconfig for iOS devices and thunderbird.
